export default function ProjectCard() {
  ...
  return (
    <div className='projectcard'>
      ...
      <div className='w-full h-56 bg-yellow-200'></div>
      ...
      <div className='flex p-3 justify-end w-full'>
        <svg
          ...
          height='32'
          viewBox='0 0 32 32'
          className='fill-current mr-5 hover:text-green-400 cursor-pointer'
        >
          <title>github</title>
        ...
        <svg
          ...
          height='32'
          viewBox='0 0 32 32'
          className='fill-current hover:text-green-400 cursor-pointer'
        >
          <title>link</title>
